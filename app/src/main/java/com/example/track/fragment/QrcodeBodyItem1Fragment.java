...
public class QrcodeBodyItem1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.recycleview_body_qrcode_item1, container, false);
        recyclerView = v.findViewById(R.id.recycleview_body_qrcode_item1);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this.getContext());
        recyclerView.setLayoutManager(linearLayoutManager);
        Item1Adapter adapter = new Item1Adapter();
...
//        call = findViewById(R.id.body_qrcode_item1_button_call);
//        sos = findViewById(R.id.body_qrcode_item1_button_sos);
//        fix = findViewById(R.id.body_qrcode_item1_button_fix);
//
//        call_img = findViewById(R.id.body_qrcode_item1_image_call);
//        sos_img = findViewById(R.id.body_qrcode_item1_image_sos);
//        fix_img = findViewById(R.id.body_qrcode_item1_image_fix);
